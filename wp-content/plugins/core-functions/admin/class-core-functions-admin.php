...
class Core_Functions_Admin {
	...
	public function cf_admin_init_callback() {
		...
		foreach( $roles as $_role ) {
			...
			$role->add_cap( 'read_private_client-log' );
			$role->add_cap( 'edit_client-log' );
			$role->add_cap( 'edit_client-log' );
			$role->add_cap( 'edit_others_client-log' );
			$role->add_cap( 'edit_published_client-log' );
			$role->add_cap( 'publish_client-log' );
			$role->add_cap( 'delete_others_client-log' );
			$role->add_cap( 'delete_private_client-log' );
			$role->add_cap( 'delete_published_client-log' );
		}
	}
}
